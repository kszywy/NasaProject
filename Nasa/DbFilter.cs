                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        this.filteredSpaceList.Add(new SpaceWeatherCombined(
                            ...
                            reader.GetString(1),                                // EventId
                            reader.IsDBNull(2) ? null : reader.GetString(2),    // EventType
                            reader.IsDBNull(3) ? null : reader.GetString(3),    // BeginTime
                            reader.IsDBNull(4) ? null : reader.GetString(4),    // PeakTime
                            reader.IsDBNull(5) ? null : reader.GetString(5),    // EndTime
                            reader.IsDBNull(6) ? null : reader.GetString(6),    // ClassType
                            reader.IsDBNull(7) ? null : reader.GetString(7),    // SourceLocation
                            reader.IsDBNull(8) ? null : reader.GetString(8),    // ActiveRegion
                            reader.IsDBNull(9) ? null : reader.GetString(9),    // Instruments
                            reader.IsDBNull(10) ? null : reader.GetString(10),  // Note (nullable)
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        this.filteredEarthList.Add(new EarthWeatherCombined(
                            ...
                            reader.IsDBNull(1) ? null : reader.GetString(1),    // Country
                            reader.IsDBNull(2) ? null : reader.GetString(2),    // LocationName
                            reader.IsDBNull(3) ? null : reader.GetString(3),    // Timezone
                            DateOnly.FromDateTime(reader.GetDateTime(4)),       // Date
                            reader.IsDBNull(5) ? null : reader.GetDouble(5),    // TemperatureCelsius
                            reader.IsDBNull(6) ? null : reader.GetString(6),    // ConditionText
                            reader.IsDBNull(7) ? null : reader.GetDouble(7),    // WindKph
